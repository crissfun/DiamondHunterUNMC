//Changes were made to playstate.java in the populateItems()
...
private void populateItems() {
		...
		item = new Item(tileMap);
		item.setType(Item.AXE);
		item.setTilePosition(26, 37); //default axe location
		items.add(item);
		
		item = new Item(tileMap);
		item.setType(Item.BOAT);
		item.setTilePosition(12, 4);//default boat location
		items.add(item);
		
		try { //printcoordinates of axe and boat in itemsandcharacter.txt
	...
	item = new Item(tileMap);
	item.setType(Item.AXE);
	item.setTilePosition(index.get(1),index.get(0)); //read coordinates of axe as the first 2 digits in .txt
	items.add(item);
	
	item = new Item(tileMap);
	item.setType(Item.BOAT);
	item.setTilePosition(index.get(3),index.get(2));//read coordinates of boat as the last 2 digits in .txt
	items.add(item);
}
